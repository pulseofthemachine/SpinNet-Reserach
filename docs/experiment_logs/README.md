...
Structured experiment logs organized by date and experiment type.
...
│   ├── config.md     # Training configuration (optional)
│   └── analysis.md   # Detailed analysis output (optional)
├── future_ideas.md   # Research backlog
└── README.md
```
